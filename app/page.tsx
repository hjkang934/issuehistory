...
const ISSUE_TYPES = ["가격변동", "납기지연", "품질문제", "계약변경", "기타"];
...
const INITIAL_DATA: Issue[] = [
  { id: 1, date: "2025-09-02", company: "CFOFC", direction: "수입", lotNo: "25-4", product: "다심케이블(8C)", defect: "0.9mm 버퍼가 너무 헐렁해 탈피가 비정상적으로 잘 이뤄짐", compensation: "대체품 무상 제공 요청", result: "보상물량 총 1km 무상으로 다음 발주시 제공 예정 (리마인드 필요)", type: "품질문제", status: "진행중" },
  ...
  { id: 3, date: "2025-03-06", company: "Fibercan", direction: "수입", lotNo: "25-1, 3", product: "LC D-Clip", defect: "치수 불량 (결합, 조립성 문제 없음)", compensation: "도면 공차 수정 (개발팀 컨펌 완료)", result: "해당 제품 추후 발주 진행 시 리마인드 예정", type: "품질문제", status: "진행중" },
  ...
  { id: 5, date: "2025-03-25", company: "Fibercan", direction: "수입", lotNo: "24-10-2", product: "광파워미터(FPM-600, FLM-620)", defect: "포장 불량 (라벨 오염 등)", compensation: "내용 전달 및 개선 요청", result: "추후 발주건부터 개선될 예정 (리마인드 예정)", type: "품질문제", status: "진행중" },
  ...
  { id: 7, date: "2025-04-02", company: "Fibercan", direction: "수입", lotNo: "24-11-2, 25-5, 6", product: "열수축 튜브(노랑)", defect: "색상 상이", compensation: "내용 전달 및 개선 요청", result: "추후 발주건부터 개선될 예정 (리마인드 예정)", type: "품질문제", status: "진행중" },
  { id: 8, date: "2025-05-15", company: "Fibercan", direction: "수입", lotNo: "24-10-3, 25-7-1, 8", product: "FAOC Body(57mm)", defect: "FAOC Body 치수 불량 및 미성형", compensation: "개선 요청 및 전량 반품 후 대체품 입고 요청", result: "관련 CEO 별도 보고 완료", type: "품질문제", status: "진행중" },
  { id: 9, date: "2025-05-15", company: "Fibercan", direction: "수입", lotNo: "24-10-3, 25-7-1, 8", product: "광파워미터(FPM-600)", defect: "제품 불량(액정 불량) 및 외관 불량(본드흔 등)", compensation: "외관 불량: 개선 요청 / 제품 불량: 대체품 무상 제공 요청", result: "대체품 추후 광파워미터 발주 진행시 같이 입고될 예정 (리마인드 예정)", type: "품질문제", status: "진행중" },
  { id: 10, date: "2025-05-15", company: "Fibercan", direction: "수입", lotNo: "24-10-3, 25-7-1, 8", product: "Dust Cap(PC)", defect: "제품 외관 불량(Burr)", compensation: "내용 전달 및 개선 요청", result: "차기 입고분부터 개선된 제품 입고될 예정", type: "품질문제", status: "진행중" },
  ...
  { id: 14, date: "2025-06-05", company: "FLC", direction: "수입", lotNo: "25-3", product: "피그테일(SC/PC)", defect: "커넥터 정렬 불량 및 포장 불량", compensation: "업체 내용 전달 및 개선 요청", result: "추후 발주건 피그테일 포장 사진 전달받아 공유 예정", type: "품질문제", status: "진행중" },
  ...
  { id: 17, date: "2025-07-16", company: "FLC", direction: "수입", lotNo: "25-4", product: "OJC(LC type)", defect: "인장성능 부적합으로 인한 외피 이탈", compensation: "대체품 무상 제공 요청", result: "대체품 무상 입고 완료(2025/08/26)했으나 재불량 확인, 대체품 추가 발송 예정(09/29 입고 예상)", type: "품질문제", status: "진행중" },
  { id: 18, date: "2025-09-09", company: "FLC", direction: "수입", lotNo: "25-5", product: "OJC(LC type)", defect: "인장성능 부적합으로 인한 외피 이탈", compensation: "대체품 무상 제공 요청", result: "대체품 추석 이후 입고 예상", type: "품질문제", status: "진행중" },
  { id: 19, date: "2025-02-04", company: "Grandway", direction: "수입", lotNo: "25-1", product: "초소형 파워미터(FHP-12-B)", defect: "액정창 내 이물유입 및 버튼음 불량", compensation: "내용 전달 및 대체품 무상 제공 요청", result: "대체품 추후 광파워미터 발주 진행시 같이 입고될 예정 (리마인드 예정)", type: "품질문제", status: "진행중" },
  ...
  { id: 26, date: "2025-08-07", company: "Huamai", direction: "수입", lotNo: "25-3-2, 6", product: "IDC 보호기", defect: "실크인쇄 미적용(KT 로고 등) 및 소박스 시안(KC 인증 마크) 미적용", compensation: "시안 재전달 및 수정 요청", result: "Huamai 측 수정 진행 중", type: "품질문제", status: "진행중" },
  ...
  { id: 28, date: "2025-04-02", company: "Neofibo", direction: "수입", lotNo: "25-1, 2", product: "LC/APC 연마지그", defect: "지그 하우징 변형", compensation: "수리용 부품 무상 제공 요청", result: "추후 발주건에 무상 제공 예정 (리마인드 필요)", type: "품질문제", status: "진행중" },
  { id: 29, date: "2024-12-24", company: "ORC", direction: "수입", lotNo: "24-3-6, 4-5, 5-1", product: "스플리터(RNM-12)", defect: "PDL 불량 및 어댑터 슬리브 파손", compensation: "전수검사비용 청구 및 불량 대체품 공급 요청", result: "물품 대금 정산시 해당 비용 차감(완료), 불량 대체품 추후 동일제품 발주시 추가 입고 예정", type: "품질문제", status: "진행중" },
];
...
export default function Home() {
  ...
  const filtered = issues
    .filter((i) => filter === "전체" || i.direction === filter)
      ...
      <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem" }}>
        {[
          ...
          <div key={label} onClick={() => setFilter(label)} style={{
            flex: 1, padding: "1rem", borderRadius: "8px", textAlign: "center",
            background: filter === label ? color : "#f5f5f5",
            color: filter === label ? "white" : "#333",
            cursor: "pointer", transition: "all 0.2s",
          }}>
            <div style={{ fontSize: "0.85rem", marginBottom: "4px" }}>{label}</div>
      ...
      <details style={{ background: "#f5f5f5", padding: "1rem", borderRadius: "8px", marginBottom: "2rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "1rem" }}>
          <div style={{ display: "flex", gap: "0.5rem" }}>
            <input placeholder="거래처명" value={company} onChange={(e) => setCompany(e.target.value)}
              style={{ flex: 2, padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
            <input placeholder="입고차수" value={lotNo} onChange={(e) => setLotNo(e.target.value)}
              style={{ flex: 1, padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
          </div>
          <div style={{ display: "flex", gap: "0.5rem" }}>
            {["수입", "수출"].map((d) => (
              <button key={d} onClick={() => setDirection(d)} style={{
                flex: 1, padding: "0.5rem", borderRadius: "4px", cursor: "pointer", border: "1px solid #ccc",
                background: direction === d ? (d === "수입" ? "#0070f3" : "#e67e22") : "white",
                color: direction === d ? "white" : "#333", fontWeight: direction === d ? "bold" : "normal",
              }}>{d}</button>
            ))}
          </div>
          <input placeholder="제품군" value={product} onChange={(e) => setProduct(e.target.value)}
            style={{ padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
          <textarea placeholder="불량증상" value={defect} onChange={(e) => setDefect(e.target.value)} rows={2}
            style={{ padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
          <textarea placeholder="보상방안/요청사항" value={compensation} onChange={(e) => setCompensation(e.target.value)} rows={2}
            style={{ padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
          <textarea placeholder="처리결과" value={result} onChange={(e) => setResult(e.target.value)} rows={2}
            style={{ padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }} />
          <select value={type} onChange={(e) => setType(e.target.value)}
            style={{ padding: "0.5rem", borderRadius: "4px", border: "1px solid #ccc" }}>
            {ISSUE_TYPES.map((u) => <option key={u}>{u}</option>)}
          </select>
          <button onClick={addIssue} style={{
            padding: "0.6rem", background: "#0070f3", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", fontWeight: "bold"
          }}>등록</button>
        </div>
      </details>
        ...
        <div key={issue.id} style={{ border: "1px solid #ddd", borderRadius: "8px", padding: "1rem", marginBottom: "1rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
              ...
              <span style={{
                background: issue.direction === "수입" ? "#e0f0ff" : "#fde8d0",
                color: issue.direction === "수입" ? "#0070f3" : "#e67e22",
                padding: "2px 8px", borderRadius: "4px", fontSize: "0.8rem", fontWeight: "bold"
              }}>{issue.direction}</span>
            </div>
          ...
          <select value={issue.status} onChange={(e) => changeStatus(issue.id, e.target.value)}
            style={{ padding: "0.25rem 0.5rem", borderRadius: "4px", border: "1px solid #ccc", ...statusStyle(issue.status) }}>
